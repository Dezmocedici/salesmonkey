...
require_once($_SERVER['DOCUMENT_ROOT'] . "/assets/functions/get.data.php");
...
function addcampaign($conn)
{
    if (isset($_POST['add_campaign']))
    {
        ...
        } else if ($type == "template" && $template_id > 0)
        {
        ...
        {
            $sql = "INSERT INTO campaigns (user_id, business_id, name, recipient, subject, body, type) values('$user_id','$business_id','$name','$email_str','$subject' , '$type' , 'pending')";
        ...
        } else
        {
            ...
            $upload_ok = 0;
            if ($response == "success") {
                $sql = "INSERT INTO campaigns (user_id, business_id, name, recipient, subject, body, type) values('$user_id','$business_id','$name','$name','$customers','$subject' , '$type' , 'pending')";
                $upload_ok = 1;
            } else {
                $sql = "INSERT INTO campaigns (user_id, business_id, name, recipient, subject, body, type) values('$user_id','$business_id','$name','$name','$customers','$subject' , '$type' , 'pending')";
            }
