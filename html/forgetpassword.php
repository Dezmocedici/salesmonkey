...
<div id="content-wrapper-guest" class="d-flex flex-column justify-content-center align-items-center">
    <div id="card-wrapper" class="d-flex flex-column justify-content-center align-items-center">
        ...
        <div class="card shadow-lg border-0 content-card" data-aos="fade" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
            <div class="card-body">
                <h2 class="mt-2 mb-4 text-left text-dark text-wrap"><strong>Forget Password</strong><br></h2>
                <p class="text-muted">Please enter your email address and click on button below.<br></p>
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-12">
                            ...
                            <form method="post">
                                ...
                                <div class="form-row">
                                    <div class="col-12">
                                        <div class="form-group"><label>Email</label>
                                          <input class="form-control" type="email" placeholder="Email" name="email" required></div>
                                    </div>
                                ...
                                <!-- Start: Button & Links -->
                                <div class="form-row">
                                    <div class="col-12 text-center"><button class="btn btn-dark btn-block mb-3" data-bss-hover-animate="pulse" type="submit" name="send_link_button">Send E-mail</button>
                                        <hr>
